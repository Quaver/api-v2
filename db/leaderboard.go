...
// GetGlobalLeaderboardForMode Retrieves the global leaderboard for a specific game mode
func GetGlobalLeaderboardForMode(mode enums.GameMode, page int, limit int) ([]*User, error) {
